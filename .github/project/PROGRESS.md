...
| W-021 | M1 | Fujifilm observational diagnostic probe | W-020 / F-G0 | Build/install succeeds; bounded logs distinguish discovery/session/catalog/items/PTP/errors/restrictions; capture markers and log export; safe idempotent start/stop; no downloads/writes/shutter commands | In progress | Browser-only read-only discovery implementation authored in this PR; no Apple SDK compile or USB test here. Session/catalog/file/PTP callbacks remain pending after physical enumeration |
