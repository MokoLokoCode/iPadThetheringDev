...
5. Read [GIT.md](GIT.md) before your first commit — branch, rebase, and pull-request rules. `main` is protected and more than one person works here, so **pull main and rebase before starting**, not after.
